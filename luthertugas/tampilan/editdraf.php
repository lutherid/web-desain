...
$id=$_GET['ID'];
$cari=mysql_query("SELECT *FROM draf WHERE id_draf='$id'");
				...
				<div class="navbar-header pull-left">
					<a href=".." class="navbar-brand">
						<small>
							...
							Welcome Oceans Tour And Travel
						</small>
					</a>
				</div>
			</div>
			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								<form method="POST" action="../proses/simpaneditdraf.php">
								<!-- PAGE CONTENT BEGINS -->
								<div class="col-sm-10">
									<input type="hidden" name="id_draf" value="<?php echo $tampil['id_draf'] ?>">
									<label>Label</label>
									<span class="input-icon">
										<input type="text" name="label" id="form-field-icon-1" value="<?php echo $tampil['label'] ?>" />
										<i class="ace-icon fa fa-tags blue"></i>
									</span>
									<label><b>Judul</b></label>
									<span class="input-icon">
										<input type="text" name="judul" id="form-field-icon-1" placeholder="Judul" value="<?php echo $tampil['judul'] ?>" />
								...
								<div>
									<textarea class="ckeditor" name="data" ><?php echo $tampil['data'] ?></textarea>
								</div>
